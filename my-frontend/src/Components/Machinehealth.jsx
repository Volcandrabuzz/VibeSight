...
const MachineHealth = () => {
  ...
  const generateReport = async () => {
    if (!prompt.trim()) {
      setReportError("Please enter a prompt!");
      return;
    }
    setReportError("");
    ...
    try {
      ...
      setReportError("Failed to generate report. Please check your server.");
    } finally {
    ...
    <>
      <div className="d-flex">
        <div className="sidebar" style={dynamicStyles2}>
          ...
          {!collapse &&
            <>
              <div className="p mt-3 " style={{backgroundColor:"white",color:"black"}} onClick={() => navigate("/Machinehealth")}><i className="fa-solid fa-screwdriver-wrench me-3"></i>Health</div>
            </>
          }
          {collapse && 
            <>
        ...
        <div style={dynamicStyles}>
          ...
          {!src && !updone && 
            <>
              <div className="my-5 shadow" style={{backgroundColor:"black",height:"35vh",width:"50vw",border:"1px solid white",display:"flex",justifyContent:"center",flexDirection:"column",alignItems:"center",borderRadius:"5px"}}>
                <div style={{backgroundColor:"#CFE2FF",height:"75%",width:"90%",display:"flex",justifyContent:"center",flexDirection:"column",border:"2px dotted white",borderRadius:10+"px",alignItems:"center"}}>
          ...
          {msrc && src && 
            <>
              ...
              <div className="mt-4 mb-4 shadow" style={{backgroundColor:"black",height:"70vh",width:"50vw",border:"1px solid white",display:"flex",justifyContent:"center",flexDirection:"column",alignItems:"center",borderRadius:"5px"}}>
                <video src={msrc} style={{height:"100%",width:"100%",objectFit:"contain"}} controls></video>
              </div>

              {/* Report Generation Section */}
              <div className="mb-5 shadow" style={{backgroundColor:"black",width:"50vw",border:"1px solid white",padding:"30px",borderRadius:"5px"}}>
                <h2 style={{fontSize:"1.8rem",fontWeight:"700",marginBottom:"20px",color:"white",textAlign:"center"}}>
                ...
                <textarea
                  ...
                  placeholder="Enter a prompt like 'Analyze vibration data for anomalies'..."
                  value={prompt}
                ...
                {reportError && (
                  <p style={{color:"#ff6b6b",marginTop:"15px",fontSize:"16px"}}>
                    {reportError}
                  </p>
                )}
                {generatedReport && (
                  <div style={{
                    ...
                    <h3 style={{fontWeight:"600",fontSize:"1.3rem",marginBottom:"15px",color:"white"}}>
                      🩺 Generated Report:
                    </h3>
                    <p style={{whiteSpace:"pre-line",color:"#e0e0e0",lineHeight:"1.6",fontSize:"15px"}}>
                      {generatedReport}
                    </p>
                  </div>
                )}
